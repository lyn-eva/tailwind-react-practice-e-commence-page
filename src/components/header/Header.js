    ...
    <header className="relative bg-white">
      <div className="flex justify-between py-4 mx-auto w-11/12 max-w-7xl mobile:py-5">
        <div className="flex items-center">
          ...
          <nav className="ml-8 ">
            <ul className={`hidden absolute z-10 top-0 left-0 h-screen pl-8 pr-28 pt-20 bg-white shadow-md -translate-x-${navOn ? 0 : 60} duration-300 mobile:static mobile:flex gap-4 mobile:p-0 mobile:h-fit mobile:shadow-none mobile:translate-x-0`}>
              <img
